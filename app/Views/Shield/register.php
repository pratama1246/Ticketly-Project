    ...
    <div class="w-full max-w-[1150px] min-h-[520px] bg-[#ffe398] rounded-[25px] border border-black p-10 md:p-18 flex flex-col md:flex-row gap-4">
        ...
        <div class="w-full md:w-1/2">
            ...
            <form action="<?= url_to('register') ?>" method="post" class="space-y-5">
                ...
                <!-- CONFIRM PASSWORD -->
                <div>
                    <label class="block font-medium mb-1 text-gray-900">Confirm Password</label>
                    <div class="relative">
                        <input type="password" name="password_confirm" id="password_confirm" class="w-full rounded-md border border-gray-300 px-4 py-2 pr-10 focus:ring-2 focus:ring-blue-400 outline-none bg-white" required>
