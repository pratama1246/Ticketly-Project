<main class="w-full pt-24 flex-grow bg-white">
    <div class="relative py-20 bg-blue-900 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 text-center text-white">
            <h1 class="text-4xl md:text-6xl font-bold mb-6">Tentang Ticketly</h1>
            <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
                Platform tiket event masa depan yang menghubungkanmu dengan pengalaman tak terlupakan.
            </p>
        </div>
    </div>
